...
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/client",children:e.jsx(n.code,{children:"Client"})}),", to query blockchain information."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/txbuilder",children:e.jsx(n.code,{children:"TxBuilder"})}),", to interact with the blockchain."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/webhooks",children:e.jsx(n.code,{children:"Webhooks"})}),", to subscribe to on-chain events."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"/constants",children:e.jsx(n.code,{children:"Constants"})}),", to get the chain configuration values."]}),`
`]}),`
